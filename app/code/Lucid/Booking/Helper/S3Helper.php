...
class S3Helper extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->scopeConfig->getValue('ep1_thai_s3/general/access_key');
    }

    public function getSecretKey()
    {
        return $this->scopeConfig->getValue('ep1_thai_s3/general/secret_key');
    }

    public function getBucket()
    {
        return $this->scopeConfig->getValue('ep1_thai_s3/general/bucket');
    }

    public function getRegion()
    {
        return $this->scopeConfig->getValue('ep1_thai_s3/general/region');
    }
