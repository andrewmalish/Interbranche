...
use Lucid\Booking\Api\Data\Ep1AdditionalOrderDataInterface;

class Ep1AdditionalOrderData extends \Magento\Framework\Model\AbstractModel implements Ep1AdditionalOrderDataInterface
{

    protected $_eventPrefix = 'lucid_booking_ep1additionalorderdata';
    ...
    {
        $this->_init('Lucid\Booking\Model\ResourceModel\Ep1AdditionalOrderData');
    }
